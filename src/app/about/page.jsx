export default function About() {
  return (
    <div className="max-w-6xl mx-auto p-3 space-y-4">
      ...
      <p>
        Welcome to out movie database website! We are a team of passionate movie
        enthusiasts who have come together to create a non-stop desitnation for
        all your movie-related needs.
      </p>

      <p>
        Our website is designed to provide you with a comprehensive database of
        movies from all aroud the world, along with the latest news, reviews,
        and trailers. Our mobie database is constantly updated with new
        ...
        actor, genre, or release date, making it east to find the prefect movie
        for any occasion.
      </p>
      ...
      <p>
        ...
        and trailers, keeping you updated with the altest happenings in the
        world of cinema. Thank you for visiting out website and we hope you
        enjoy your time browsing through our movie database. If you have any
        feedback or suggestion, please feel free to contact us. We are always
        looking for ways to imporove and enhance the user experiance on out
